...
The Orca Trading Bot is a software tool designed to automate the buying and selling of tokens on the Solana blockchain.
...
The current version has undergone multiple optimizations, including stability and processing speed improvements, making it better suited for the complexity of the current Solana market.
...
## User Success
![](readme/user-success-1.png)
![](readme/user-success-2.png)
...
- If you need custom features or assistance, feel free to contact the admin team on discord for dedicated support. Discord: `orca_chic` 
